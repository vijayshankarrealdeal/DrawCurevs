...
const CURVE_HEIGHT = 110.0;
const AVATAR_RADIUS = CURVE_HEIGHT * 0.0;
const AVATAR_DIAMETER = AVATAR_RADIUS * 4;
...
class _MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Offset bottomLeft = Offset(0, size.height * 0.35);
    Offset topRight = Offset(size.width, 0);
    Offset bottomRight = Offset(size.width, size.height * 0.45);
